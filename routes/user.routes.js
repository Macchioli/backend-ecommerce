...
//PUT users
router.put("/users/:id", [auth, upload], userController.updateUser) /* Paso por la función middleware auth, si quiero dos o mas middlewares debería ponerlos en array [auth, ___, ___] */
//POST login
